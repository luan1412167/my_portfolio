                ...
                <div className="timeline-centered">
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2>Undergraduation <span>2014-2018</span></h2>
                        <p>I have learned and researched many things at my university. Something about Math, image processing, Artificial Intelligence.</p> 
                      </div>
                    </div>
                  </article>
